...
const messages = {
    en: {
        ...
        common: {
            ...
            searchTools: 'Search by title, summary, or tag',
            searchRecipes: 'Search by title or major ingredient',
            open: 'Open',
            copy: 'Copy',
            copied: 'Copied',
            copyFailed: 'Failed',
        ...
        tools: {
            eyebrow: 'Tools',
            title: 'Tool index',
            intro: 'Small interactive utilities, experiments, and runnable demos.',
            browseEyebrow: 'Browse',
            filterTitle: 'Filter and search',
            groupsAria: 'Tool groups',
            missingPage: 'This tool does not have a runnable page yet.',
        },
        recipes: {
            eyebrow: 'Recipes',
            title: 'Recipe index',
    ...
    zh: {
        ...
        common: {
            ...
            searchTools: '按标题、摘要或标签搜索',
            searchRecipes: '按标题或主要食材搜索',
            open: '打开',
            copy: '复制',
            copied: '已复制',
            copyFailed: '复制失败',
        ...
        tools: {
            eyebrow: 'Tools',
            title: '工具索引',
            intro: '一些交互式小工具、实验和可运行 demo。',
            browseEyebrow: 'Browse',
            filterTitle: '筛选与搜索',
            groupsAria: '工具分类',
            missingPage: '这个工具还没有可运行页面。',
        },
        recipes: {
            eyebrow: 'Recipes',
            title: '食谱',
